...
Latest milestone status: `SAND_FACTOR_CONDITIONED_DEVELOPMENT_CONTROLS_RECALIBRATED_GENERATION_COMPLETE; SAND_FACTOR_CONDITIONED_DEVELOPMENT_CONTROLS_RECALIBRATED_GENERATION_READY`.

The frozen controls-recalibrated matrix was generated once: 198/198 completed, all 61 physical gates passed, and objective-valid yield was 196/198. Ordinary Support was TRAIN 24/24 and VALIDATION 12/12; delayed Support was 12/12 and 6/6. `FACTOR_VALIDATION` is generated but remains sealed from model access until a future candidate freeze. The exact recommended next milestone is `SAND_FACTOR_CONDITIONED_MODEL_TRAINING`; it has not started. Details are in [`reports/20260904_sand_factor_conditioned_development_controls_recalibrated_generation.md`](reports/20260904_sand_factor_conditioned_development_controls_recalibrated_generation.md).
