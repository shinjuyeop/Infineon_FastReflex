...
- Do not create a new runner for each experiment.
- Do not commit generated datasets or arbitrary experiment outputs.
- Keep generated data, models, and reports outside source directories.
- Keep dataset, model, and output provenance explicit and separate.
...
- Do not silently copy code, datasets, models, outputs, or dependencies from the legacy `/d/shin/Infineon` repository.
